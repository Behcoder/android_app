...
class _FeaturedProductsState extends State<FeaturedProducts> {
  ...
  Future<void> fetchFeaturedProducts() async {
    ...
    final url = Uri.parse(
        ApiService.getFeaturedProductsUrl(featuredCategoryId.toString()));
    try {
      final response = await http.get(url);
      if (response.statusCode == 200) {
        setState(() {
...
class _NewProductsState extends State<NewProducts> {
  ...
  Future<void> fetchLatestProducts() async {
    final url = Uri.parse(ApiService.getNewProductsUrl());
    try {
      final response = await http.get(url);
      if (response.statusCode == 200) {
...
class _CategoriesPageState extends State<CategoriesPage> {
  ...
  Future<void> fetchSubCategories(int parentId) async {
    final url = Uri.parse(ApiService.getSubCategoriesUrl(parentId));
    try {
      final response = await http.get(url);
      if (response.statusCode == 200) {
...
class _ProductsPageState extends State<ProductsPage> {
  ...
  Future<void> fetchProducts() async {
    ...
    String url = ApiService.getProductsUrl(page: page);
...
class _ProductDetailPageState extends State<ProductDetailPage> {
  ...
  Future<void> fetchReviews() async {
    ...
    try {
      final url =
          Uri.parse(ApiService.getProductReviewsUrl(widget.product['id']));
      final response = await http.get(url);
  ...
  Future<void> submitReview() async {
    ...
    try {
      final url = Uri.parse(ApiService.getSubmitReviewUrl());
